...
\begin{tikzpicture}[
  ...
  \node[tiny note, text=GuardGreen, anchor=south] at (7.38,2.34) {buffered read cutoff};
  ...
  \node[tiny note] at (8.23,1.55) {configurable\\read buffer};
  ...
  \node[note text] at (6.05,0.70) {The buffer reduces late-arrival risk; it does not guarantee completeness.};
\end{tikzpicture}
\endgroup
