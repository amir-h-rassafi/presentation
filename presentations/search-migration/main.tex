...
\begin{frame}{Scope: What This Is}
  \footnotesize
  \begin{columns}[T,totalwidth=\textwidth]
    \column{0.49\textwidth}
      {\bfseries\textcolor{SecondaryTeal}{This talk covers}}
      \begin{itemize}
        \item Migrating company-name search from PostgreSQL \texttt{pg\_trgm} to Elasticsearch BM25.
        \item Data movement, indexing shape, ranking validation, and operational trade-offs.
        \item Practical lessons for search-backed product flows.
      \end{itemize}

    \column{0.49\textwidth}
      {\bfseries\textcolor{PrimaryBlue}{Not this talk}}
      \begin{itemize}
        \item Vector search or embeddings.
        \item RAG context retrieval or answer generation.
        \item Replacing domain judgement with automated metrics.
      \end{itemize}
  \end{columns}

  \vspace{0.28cm}
  {\footnotesize\textcolor{MutedText}{Still useful for future RAG or hybrid search work: data freshness, identity, ranking, and observability remain the hard parts.}}
\end{frame}
...
\begin{frame}{Migration Design: Checkpointing}
  \centering
  \vspace{-0.05cm}
  \resizebox{0.76\textwidth}{!}{\input{diagrams/04-checkpoint-replay-clean.tex}}
\end{frame}

\begin{frame}{Migration Design: Shard State Machine}
  \centering
  \vspace{-0.05cm}
  \resizebox{0.91\textwidth}{!}{\input{diagrams/04-shard-state-machine.tex}}
\end{frame}
